...
public:
	...
	virtual float derivate(float x) const { return 0; };
...
public:
	...
	virtual float derivate(float x) const { return x * (1 - x); };
...
public:
	...
	virtual float derivate(float x) const { return x > 0 ? 1 : 0; };
...
public:
	...
	virtual float derivate(float x) const { return 1; };
...
public:
	...
	virtual float derivate(float x) const { return x >= 0 ? 1 : -1; };
...
public:
	...
	virtual float derivate(float x) const { return cos(x); };
...
public:
	...
	virtual float derivate(float x) const { return -2*x*exp(-x*x); };
...
public:
	...
	virtual float derivate(float x) const { return (exp(x) * (exp(x) + x + 1))/pow((exp(x) + 1), 2); };
...
public:
	...
	virtual float derivate(float x) const { return -x/(5*abs(x)*pow((abs(x)+1/5), 2)); };
